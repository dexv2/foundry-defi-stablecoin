...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATION_THRESHOLD = 50; // MUST be 200% overcollateralized
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) nonReentrant {
        ...
        _revertIfHealFactorIsBroken(msg.sender); // I don't think this would ever hit
    }

    // If we do start nearing undercollateralization, we need someone to liquidate positions

    // $100 ETH backing $50 DSC
    // $20 ETH backing $15 DSC <- DSC isn't worth a $1!!!
        ...
        nonReentrant
    {
        ...
        // Getting 0.05 + 0.005 bonus = 0.055
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        // $75 / $100 = 0.75 // 0.75 < 1 // can be liquidated

        // $1000 ETH / $100 DSC
        // collateralAdjustedForThreshold = $1000 ETH * 50 / 100 = $500
        // $500 / $100 = 5 // 5 > 1 // cannot be liquidated
    ...
    function getTokenAmountFromUsd(
        ...
        // ($1000e18 * 1e18) / ($2000e8 * 1e10) = 0.05e18 or 5e16
